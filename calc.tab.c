...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_ilustre = 3,                /* TOK_ilustre  */
  YYSYMBOL_TOK_enquanto = 4,               /* TOK_enquanto  */
  YYSYMBOL_TOK_ee = 5,                     /* TOK_ee  */
  YYSYMBOL_TOK_ou = 6,                     /* TOK_ou  */
  YYSYMBOL_TOK_caso = 7,                   /* TOK_caso  */
  YYSYMBOL_TOK_casonao = 8,                /* TOK_casonao  */
  ...
  YYSYMBOL_caso = 31,                      /* caso  */
  YYSYMBOL_enquanto = 32,                  /* enquanto  */
...
{
       0,    30,    30,    48,    55,    61,    64,    71,    80,    81,
      84,    96,   109,   131,   145,   150,   155,   160,   165,   168,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOK_ilustre",
  "TOK_enquanto", "TOK_ee", "TOK_ou", "TOK_caso", "TOK_casonao",
  "TOK_IDENT", "TOK_INTEGER", "TOK_FLOAT", "';'", "'='", "'('", "')'",
  "'{'", "'}'", "'>'", "'<'", "'!'", "'+'", "'-'", "'*'", "'/'", "'^'",
  "$accept", "program", "stmts", "stmt", "atribuicao", "caso", "enquanto",
  "logical", "lterm", "lfactor", "aritmetica", "term", "term2", "factor", YY_NULLPTR
};
...
{
      72,    85,     0,    21,    29,    48,    72,   -57,   -57,   -57,
     -57,   -57,   -57,   -57,    85,    10,   -17,    26,   -57,    91,
      91,    85,   -57,   -57,    52,   -57,    85,    85,    85,    85,
      85,    91,    24,    75,   -57,    36,    35,    15,   -57,   -17,
     -17,    26,    26,   -57,    53,    25,    91,    69,    91,    78,
      73,    79,    84,    82,   -57,   -57,    75,    72,   -57,    85,
      85,     7,    85,     7,    85,    72,     1,     7,     7,     7,
       7,     8,   -57,    95,    56,    72,   -57,    17,   -57
};
...
{
      23,    66,    36,    15,     1,     2,    28,    29,     3,    71,
       4,     1,     2,    44,    19,     3,    24,     4,    72,    77,
       1,     2,    25,    37,     3,    73,     4,    54,    26,    27,
      46,    26,    27,    45,    78,    20,    26,    27,    49,    47,
      38,    46,    21,    50,    51,    52,    26,    27,    22,    49,
      53,    30,    61,    63,    50,    51,    52,    26,    27,    46,
      23,    67,    68,     3,    69,    23,    70,    38,    55,    39,
      40,    23,    75,    26,    27,     1,     2,    41,    42,     3,
      48,     4,    11,    12,    13,    57,    60,    14,    11,    12,
      13,    59,    62,    14,    11,    12,    13,    64,    65,    14,
      11,    12,    13,    74,    76,    31,    56,    58,     0,     0,
      43
};

static const yytype_int8 yycheck[] =
{
       6,    57,    20,     1,     3,     4,    23,    24,     7,    65,
       9,     3,     4,    31,    14,     7,    14,     9,    17,    75,
       3,     4,    12,    21,     7,    17,     9,    12,    21,    22,
       6,    21,    22,    31,    17,    14,    21,    22,    13,    15,
      15,     6,    13,    18,    19,    20,    21,    22,     0,    13,
      15,    25,    50,    51,    18,    19,    20,    21,    22,     6,
      66,    59,    60,     7,    62,    71,    64,    15,    15,    26,
      27,    77,    16,    21,    22,     3,     4,    28,    29,     7,
       5,     9,     9,    10,    11,    16,    13,    14,     9,    10,
      11,    13,    13,    14,     9,    10,    11,    13,    16,    14,
       9,    10,    11,     8,    74,    14,    46,    48,    -1,    -1,
      30
};
...
static const yytype_int8 yystos[] =
{
      ...
      14,    13,     0,    29,    36,    12,    21,    22,    23,    24,
      25,    14,    33,    34,    35,    36,    33,    36,    15,    37,
      37,    38,    38,    39,    33,    36,     6,    15,     5,    13,
      18,    19,    20,    15,    12,    15,    34,    16,    35,    13,
      13,    36,    13,    36,    13,    16,    28,    36,    36,    36,
      36,    28,    17,    17,     8,    16,    31,    28,    17
};
...
#line 1466 "calc.tab.c"
  ...
  case 6: /* stmt: TOK_ilustre aritmetica ';'  */
#line 64 "calc.y"
                            {
	 		(yyval.no) = create_noh(ilustre, 1) ;
...
#line 1489 "calc.tab.c"
  ...
  case 8: /* atribuicao: caso  */
#line 80 "calc.y"
       { (yyval.no) = (yyvsp[0].no)                              ; }
#line 1495 "calc.tab.c"
    break;

  case 9: /* atribuicao: enquanto  */
#line 81 "calc.y"
           { (yyval.no) = (yyvsp[0].no)                          ; }
#line 1501 "calc.tab.c"
    break;

  case 10: /* caso: TOK_caso '(' logical ')' '{' stmts '}'  */
#line 84 "calc.y"
                                              {
				(yyval.no) = create_noh(caso, 2)                              ;
...
#line 1518 "calc.tab.c"
  ...
  case 11: /* caso: TOK_caso '(' logical ')' '{' stmts '}' TOK_casonao caso  */
#line 96 "calc.y"
                                                         {
				(yyval.no) = create_noh(caso, 3)                              ;
...
#line 1536 "calc.tab.c"
  ...
  case 12: /* caso: TOK_caso '(' logical ')' '{' stmts '}' TOK_casonao '{' stmts '}'  */
#line 109 "calc.y"
                                                                  {
				(yyval.no) = create_noh(caso, 3)                              ;
...
#line 1561 "calc.tab.c"
  ...
  case 13: /* enquanto: TOK_enquanto '(' logical ')' '{' stmts '}'  */
#line 131 "calc.y"
                                                            {
							(yyval.no) = create_noh(enquanto, 2)          ;
							(yyval.no)->children[0] = (yyvsp[-4].no)                            ;
							noh *aux = (yyvsp[-1].no)                                   ;
							if(aux->childcount == 1){
								(yyval.no)->children[1] = aux->children[0]             ;
...
#line 1596 "calc.tab.c"
  ...
  case 16: /* lterm: lterm TOK_ee lfactor  */
#line 155 "calc.y"
                                {
								(yyval.no) = create_noh(ee, 2) ;
							 (yyval.no)->children[0] = (yyvsp[-2].no)             ;
							 (yyval.no)->children[1] = (yyvsp[0].no)             ;
							}
